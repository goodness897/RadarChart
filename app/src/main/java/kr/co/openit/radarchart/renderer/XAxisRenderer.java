...
import kr.co.openit.radarchart.utils.FSize;
import kr.co.openit.radarchart.utils.MPPointD;
...
import kr.co.openit.radarchart.components.LimitLine;
import kr.co.openit.radarchart.components.XAxis;
import kr.co.openit.radarchart.components.XAxis.XAxisPosition;
    ...
    protected void drawLabels(Canvas c, float pos, MPPointF anchor) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                RadarEntry value = mXAxis.getValueFormatter().getValue(mXAxis.mEntries[i / 2], mXAxis);
                ...
                drawLabel(c, label, value.getValue(), x, pos, anchor, labelRotationAngleDegrees);
            }
        }
    }

    protected void drawLabel(Canvas c, String formattedLabel, float value, float x, float y, MPPointF anchor, float angleDegrees) {
        Utils.drawXAxisValue(c, formattedLabel, value, x, y, mAxisLabelPaint, anchor, angleDegrees, mAxis);
    }
